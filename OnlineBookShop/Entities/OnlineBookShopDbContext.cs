...
{
    public partial class OnlineBookShopDbContext : DbContext
    {
        public OnlineBookShopDbContext()
            : base("name=OnlineBookShopDbContext")
        {
        }
        ...
        public System.Data.Entity.DbSet<OnlineBookShop.Support_Class.BookDetails> BookDetails { get; set; }
    }
}
